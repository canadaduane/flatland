...
class FlatlandPoint extends Point2D.Double {
    ...
    public void computeRadial(FlatlandPoint fp) {
        ...
        if (adjacent == 0) {
            ...
            if (opposite < 0) angle = Math.PI * 2 - angle;
        }
    }
    ...
    public double xFromOrigin() {
        ...
        if (light != 0.0) {
            ...
            double velocityDiff =
                Math.pow(originVelocity * Math.sin(tempAngle) - velocityY, 2) +
                Math.pow(originVelocity * Math.cos(tempAngle) - velocityX, 2);
            ...
            tempX = (tempX * (a * a * gamma + b * b) + tempY * b * a * (1 - gamma)) /
            (a * a + b * b);
            // Wacky Warp World
    ...
    public double yFromOrigin() {
        ...
        if (light != 0.0) {
            ...
            tempY = (tempY * (a * a * gamma + b * b) - tempX * b * a * (1 - gamma)) /
            (a * a + b * b);
            // Wacky Warp World
            //double r = Math.sqrt( tempX * tempX + tempY * tempY );
            //gamma = 60;
    ...
    public void slide(double slideX, double slideY) {
        ...
        while (e.hasMoreElements()) {
            FlatlandPoint fp = (FlatlandPoint) e.nextElement();
