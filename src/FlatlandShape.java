...
class FlatlandShape {
    ...
    public void save(String filename) throws IOException {
        ...
        for (int i = 0; i < tail; i++) outFile.println(point[i].x + ", " + point[i].y);
    }
    ...
    public void add(FlatlandPoint p) {
        if (tail >= capacity) doubleCapacity();
    ...
    private void doubleCapacity() {
        ...
        for (int i = 0; i < tail; i++) point[i] = tempArray[i];
    }
    ...
    public void makeRegular(int sides, double radius) {
        if (sides > 1) {
            ...
            System.out.println(
                "FlatlandShape::makeRegular(): Can't initialize " + sides + " sides."
            );
        }
    }
    ...
    public void setVelocity(double v) {
        ...
        for (int i = 0; i < tail; i++) {
            ...
            Enumeration e = point[i].children.elements();
